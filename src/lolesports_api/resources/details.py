...
from ..types import detail_retrieve_params
...
from ..types.detail_retrieve_response import DetailRetrieveResponse
...
class DetailsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        Args:
          participant_ids: A list of the participant Ids separated by underscores and not commas
        ...
        return self._get(
            ...
            else f"https://feed.lolesports.com/livestats/v1/details/{game_id}",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    detail_retrieve_params.DetailRetrieveParams,
                ),
            ),
